...
def calibrate() -> None:
    ...
    parser_intrinsic.add_argument('--video', type=str, default='output/output.mp4', help='Path to video file')
    parser_intrinsic.add_argument('--board', type=str, default='example_boards/charuco_5x7.yaml', help='YAML File describing charuco board')
